    ...
    <nav x-data="{ isOpen: false }" class="px-4 py-4 shadow">
        <div class="lg:items-center lg:justify-between lg:flex">
            ...
            <div x-cloak :class="[isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']"
                class="absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out  shadow-md  lg:bg-transparent lg:shadow-none bg-gray-900 lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center">
