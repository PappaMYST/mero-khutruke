        ...
        <div class="bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-200">
                <form method="post" action="{{ route('categories.store') }}">
                    @csrf
                    <div class="mb-5">
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-200">Category Name:</label>
                    ...
                    <div>
                        <fieldset>
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-200">Select
                                Category:</label>
                            ...
                            <div class="flex items-center mb-4">
                                <input id="type-option-1" type="radio" name="type" value="income"
                                    ...
                                    checked>
                                <label for="type-option-1" class="block ms-2  text-sm font-medium text-gray-200">
                                    Income
                                </label>
                            </div>
                            ...
                            <div class="flex items-center mb-4">
                                <input id="type-option-2" type="radio" name="type" value="expense"
                                    class="w-4 h-4 bg-gray-700 border-gray-600 focus:ring-2 focus:ring-blue-600 focus:bg-blue-600 "
                                    checked>
                                <label for="type-option-2" class="block ms-2  text-sm font-medium text-gray-200">
                                    Expense
                                </label>
                            </div>
                        </fieldset>
